...
@onready var sprite: Sprite2D = $nahual
@onready var anim_tree: AnimationTree = $nahual/AnimationTree
...
func _on_area_2d_body_entered(body: Node2D) -> void:
	if body.has_method("dano_Recibido"):
		body.dano_Recibido(dano, direccion)
